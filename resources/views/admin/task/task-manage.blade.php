...
{{--        </div>--}}
        ...
        <div class="card jfss-own-card">
            ...
            <!-- Add Task Modal -->
            <div
                class="modal fade text-left new-task-modal"
                id="inlineForm"
                tabindex="-1"
                role="dialog"
            ...
            >
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form class="add-new-task form form-vertical">
                                    @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <label for="last-name-icon">Duration</label>
                                                <div class="input-group input-group-merge">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text"><i
                                                                data-feather="user"></i></span>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form class="edit-user-form form form-vertical">
                                    @csrf
                                    <input class="form-control hidden" id="task_id" type="text" name="task_id"
                                           value=""/>
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
